...
class GameWindow:
    ...
    def __init__(self, game_window_columns, game_window_rows, number_of_mines):
        ...
        if game_window_columns * game_window_rows < number_of_mines or number_of_mines <= 0:
            raise InputError
        else:
    ...
    def findAllZeroFieldsRecursion(self, i, j):
        """This method using recursion finds all neighbours of clicked field that are not numbers."""
