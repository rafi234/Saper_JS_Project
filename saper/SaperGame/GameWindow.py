...
class GameWindow:
    ...
    def gameWindowColumns(self, new: int):
        """Setter for _gameWindowColumns"""
    ...
    def gameWindowRows(self, new: int):
    ...
    @property
    def numberOfMines(self) -> int:
        return self._numberOfMines

    @numberOfMines.setter
    def numberOfMines(self, new: int):
